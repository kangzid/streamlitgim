...
st.markdown(
    ...
    <a href="https://www.linkedin.com/in/your-linkedin-profile-url" style="color: grey; text-decoration:none;">
    <div class="coffee_btn" >
    <img src="https://logospng.org/download/linkedin/logo-linkedin-icon-1536.png" style="max-width:20px;margin-right:10px;">
    Connect with me on LinkedIn</a></div></div>""",
